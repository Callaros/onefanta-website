...
const APP_PRIVACY_LAST_UPDATED_EN = 'August 25, 2026';
    ...
    <div className="space-y-6">
      ...
      <PolicySection title="2. Data we process">
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li><strong className="text-white">Analytics and app usage:</strong> app-instance identifier, app launch, session, screen and feature-use events, device and app information, approximate location derived from the IP address, and in-app purchase events, if any. The advertising identifier may be collected when available and permitted by applicable settings.</li>
          <li><strong className="text-white">Advertising and impression-level revenue:</strong> advertising or installation identifiers, IP address, device and app information, ads displayed and related interactions, ad source and format, value and currency attributed to an individual impression, value precision level, diagnostics and consent choices.</li>
        </ul>
      </PolicySection>
      <PolicySection title="3. Purposes and legal bases">
        <ul className="ml-4 list-inside list-disc space-y-2">
          ...
          <li><strong className="text-white">Analytics and measurement:</strong> understanding app usage, measuring feature and ad performance, attribution, and calculating aggregated metrics such as lifetime value and advertising revenue through Google Analytics for Firebase. Where applicable law requires consent, collection follows your in-app choices.</li>
      ...
      <PolicySection title="8. Analytics, advertising and consent management">
        <p className="mb-3">OneFanta uses Google Analytics for Firebase to understand how the app is used, measure its performance and connect advertising events with usage statistics. The service may assign an app-instance identifier to the installation and automatically collect app launch, session, screen, device, app-version and approximate-location events derived from the IP address.</p>
        <p className="mb-3">OneFanta uses Google Mobile Ads and has enabled impression-level ad revenue measurement. For each ad displayed, Google may make available and transmit to Firebase and Google Analytics the value attributed to the impression, currency, ad source and format, and the value precision level. This data is used for reporting, attribution, revenue measurement and aggregated metrics such as user lifetime value and return on advertising spend.</p>
        <p className="mb-3">Advertising data may include advertising or installation identifiers, IP address, device and app characteristics, ad interactions, diagnostics and consent information. OneFanta does not sell personal data. If you do not consent to personalisation, the app may still display non-personalised ads in accordance with your choices.</p>
        <p>The app presents its advertising and analytics consent mechanism before starting processing that requires consent. Your choices determine how Google and authorised advertising providers may process data for storage, measurement, analytics and ad personalisation. You may change or withdraw your choices through the privacy settings available in the app; withdrawal does not affect the lawfulness of processing carried out beforehand.</p>
      </PolicySection>
      <PolicySection title="9. Recipients and international transfers">
        <p>Where necessary, data may be processed by members of private leagues for shared game data and content; Supabase for backend, authentication and storage in Central Europe (Frankfurt); Google and Apple for the federated sign-in selected by the user; Functional Software, Inc. (Sentry) for diagnostics; Google and authorised providers for Firebase Cloud Messaging, Google Analytics for Firebase and Google Mobile Ads, including impression-level revenue measurement; and Resend for transactional emails, including the recipient's email address, message content and delivery metadata. Sentry processes events in the EU region. Processing outside the EEA relies on safeguards recognised by applicable law, including adequacy decisions, the Data Privacy Framework or Standard Contractual Clauses.</p>
