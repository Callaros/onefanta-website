...
export function AppPrivacyPolicyEn() {
  return (
    <div className="space-y-6">
      <p className="text-dark-400">Last updated: {LAST_UPDATED_EN}</p>
      <PolicySection title="1. Data controller and scope">
        ...
        <p>This notice describes personal data processing in the OneFanta mobile app. The landing page and waitlist are covered by the <a href="/en/waitlist-privacy" className="text-electric-300 underline underline-offset-4 hover:text-electric-200">Waitlist Privacy Policy</a>.</p>
      </PolicySection>
      <PolicySection title="2. Data we process">
        <ul className="ml-4 list-inside list-disc space-y-2">
          <li><strong className="text-white">Account and contact data:</strong> email, user ID, login information and preferences.</li>
      ...
      <PolicySection title="3. Purposes and legal bases">
        <ul className="ml-4 list-inside list-disc space-y-2">
          <li><strong className="text-white">Providing the service:</strong> account creation, authentication, game data, leagues, teams, standings and requested content, based on performance of the requested service.</li>
      ...
      <PolicySection title="5. Sentry and diagnostic data">
      ...
      <PolicySection title="7. Advertising and consent management">
      ...
      <PolicySection title="8. Recipients and international transfers">
        <p>Where necessary, data may be processed by members of private leagues for shared game data and content; Supabase for backend, authentication and storage in Central Europe (Frankfurt); Functional Software, Inc. (Sentry) for diagnostics; Google and authorised providers for Firebase Cloud Messaging and Google Mobile Ads; and email providers. Sentry processes events in the EU region. Processing outside the EEA relies on safeguards recognised by applicable law, including adequacy decisions, the Data Privacy Framework or Standard Contractual Clauses.</p>
        <p className="mt-3">See the privacy notices of <a href="https://supabase.com/privacy" className="text-electric-300 underline underline-offset-4 hover:text-electric-200">Supabase</a>, <a href="https://sentry.io/privacy/" className="text-electric-300 underline underline-offset-4 hover:text-electric-200">Sentry</a> and <a href="https://policies.google.com/privacy" className="text-electric-300 underline underline-offset-4 hover:text-electric-200">Google</a>.</p>
      </PolicySection>
      ...
      <PolicySection title="10. Account and data deletion">
        ...
        <p>See <a href="/en/delete-account" className="text-electric-300 underline underline-offset-4 hover:text-electric-200">Account and data deletion</a> for details. You may separately exercise GDPR rights by contacting <EmailLink />.</p>
      </PolicySection>
      <PolicySection title="11. Required data and optional features">
        <p>Email, credentials and required game data are necessary for an account and restricted features. Image uploads, notifications and consent-based advertising processing are optional. Refusal or withdrawal does not prevent use of unrelated app features. Support requests are optional, but we cannot respond without the necessary details.</p>
      </PolicySection>
      ...
      <PolicySection title="14. Your rights and complaints">
      ...
      <PolicySection title="15. Store disclosures and updates">
...
export function CookiePolicyEn() {
  return (
    <div className="space-y-6">
      ...
      <PolicySection title="4. Mobile app"><p>This Cookie Policy covers the website. Advertising consent and identifiers in the mobile app are described in the <a href="/en/privacy" className="text-electric-300 underline underline-offset-4 hover:text-electric-200">App Privacy Policy</a>.</p></PolicySection>
