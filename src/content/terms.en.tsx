  ...
  return (
    <div className="space-y-8">
      ...
      <PolicySection title="11. Third-party services, stores, advertising and purchases">
        <p className="mb-3">The app is distributed through Apple App Store and, subject to availability, through Google Play Store or a direct Android APK download from the official website. Features may depend on Supabase, Sportmonks, Sentry, Firebase Cloud Messaging and Google Mobile Ads. The website also uses Cloudflare for hosting, storage, delivery and security. Their own terms and notices may apply.</p>
      ...
      <PolicySection title="12. Territorial availability"><p>OneFanta currently imposes no general territorial restriction. Availability may depend on availability through an app store or the official website in your country, device compatibility, third-party services and local law. You are responsible for ensuring use is permitted where you are located.</p></PolicySection>
