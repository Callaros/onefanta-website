...
export default function TermsEn({ locale }: { locale: Locale }) {
  return (
    <div className="space-y-8">
      ...
      <PolicySection title="12. Territorial availability"><p>OneFanta currently imposes no general territorial restriction. Availability may depend on availability through Apple App Store or Google Play Store in your country, device compatibility, third-party services and local law. You are responsible for ensuring use is permitted where you are located.</p></PolicySection>
