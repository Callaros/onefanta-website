...
import { EmailLink, LAST_UPDATED } from './legal.it';
import type { Locale } from '../lib/i18n';

function TermsIt({ locale }: { locale: Locale }) {
  return (
    <div className="space-y-8">
      ...
      <PolicySection title="11. Servizi di terzi, store, pubblicità e acquisti">
        <p className="mb-3">
            L'app è distribuita tramite Apple App Store e, in base alla disponibilità, tramite Google Play Store. Alcune funzioni possono
          ...
          <p className="mb-3">
            ...
            sono disponibili nella <LocalizedLink locale={locale} href="/privacy">Privacy Policy dell'app</LocalizedLink>.
        ...
        <PolicySection title="12. Disponibilità territoriale">
          <p>
            ...
            dipendere dalla disponibilità su Apple App Store o Google Play Store nel Paese dell'utente, dalla compatibilità del
        ...
        <PolicySection title="14. Sospensione, chiusura dell'account e segnalazioni">
          <p className="mb-3">
            ...
            <LocalizedLink locale={locale} href="/delete-account">Cancellazione dell'account e dei dati</LocalizedLink>.
          </p>
          <p>
